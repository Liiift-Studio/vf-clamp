	...
	return (
		<main className="flex flex-col items-center px-6 py-20 gap-24">
			...
			<section className="w-full max-w-2xl lg:max-w-5xl flex flex-col gap-6">
				...
				<MagnetBlock className="text-base opacity-60 leading-relaxed max-w-lg" minWeight={300} maxWeight={600} spreadRadius={220}>
		...
		<section className="w-full max-w-2xl lg:max-w-5xl flex flex-col gap-4">
			...
			<MagnetBlock className="text-sm opacity-50 leading-relaxed max-w-lg" minWeight={300} maxWeight={600} spreadRadius={220}>
			...
			<section className="w-full max-w-2xl lg:max-w-5xl flex flex-col gap-6">
				...
				<MagnetBlock className="text-sm opacity-60 leading-relaxed max-w-lg" minWeight={300} maxWeight={600} spreadRadius={220}>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					...
					<div className="flex flex-col gap-3 rounded-xl p-6" style={{ background: "rgba(0,0,0,0.2)" }}>
						...
						<MagnetBlock className="text-xs opacity-50 leading-relaxed" minWeight={300} maxWeight={600} spreadRadius={220}>
		...
		{/* How it works */}
			<section className="w-full max-w-2xl lg:max-w-5xl flex flex-col gap-6">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-12 text-sm leading-relaxed opacity-70 prose-grid">
					<div className="flex flex-col gap-3">
						...
						<MagnetBlock minWeight={300} maxWeight={600} spreadRadius={220}>
			...
			<section className="w-full max-w-2xl lg:max-w-5xl flex flex-col gap-6">
				...
				<div className="flex flex-col gap-8 text-sm">
					...
					<div className="flex flex-col gap-3">
						<MagnetBlock className="opacity-50" minWeight={300} maxWeight={600} spreadRadius={220}>From named instances — hull computed automatically</MagnetBlock>
...
for (const result of results) {
  await writeFile(\`Omnes-\${result.name}-VF.ttf\`, result.buffer)
					...
					<div className="flex flex-col gap-3">
						<MagnetBlock className="opacity-50" minWeight={300} maxWeight={600} spreadRadius={220}>From explicit axis ranges</MagnetBlock>
  ...
  outputs: [
    ...
    { name: 'SemiCondensed', axes: { wdth: { min: 87.5, max: 100 } } },
					...
					<div className="flex flex-col gap-3">
						<MagnetBlock className="opacity-50" minWeight={300} maxWeight={600} spreadRadius={220}>Mix instances and axes — axes override the hull</MagnetBlock>
						<CodeBlock code={`const results = await clampFont(source, {
  format: 'woff2',
  outputs: [
    {
      ...
      axes: { opsz: { min: 8, max: 24 } },
					...
					<div className="flex flex-col gap-3">
						<MagnetBlock className="opacity-50" minWeight={300} maxWeight={600} spreadRadius={220}>CLI — from the shell</MagnetBlock>
...
# tag:*  tag:keep → keep full original range (explicit no-op)`} />
					...
					<div className="flex flex-col gap-3">
						<MagnetBlock className="opacity-50" minWeight={300} maxWeight={600} spreadRadius={220}>Axis value reference</MagnetBlock>
