...
const CMD = "npm install @liiift-studio/vf-clamp"
const NPM_URL = "https://www.npmjs.com/package/@liiift-studio/vf-clamp"
...
export default function CopyInstall() {
	...
	function handleCopy() {
		navigator.clipboard.writeText(CMD).then(() => {
			...
			// Clipboard write failed (no HTTPS or permission denied) — no-op
		})
	}
