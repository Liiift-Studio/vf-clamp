...
const TOOLS = [
	...
	{ name: "Optical Margin", url: "https://opticalmargin.com",                  id: "opticalMargin", desc: "Hangs punctuation beyond the text block for optical alignment",        short: "Hang punctuation"       },
